-- This migration ensures the messages table has the correct structure
-- and fixes any issues with the content column type

-- First, drop the trigger that depends on the function
DROP TRIGGER IF EXISTS notify_on_new_message_trigger ON messages;

-- Then drop the functions in the correct order
...
BEGIN
  -- Insert the notification with text content
