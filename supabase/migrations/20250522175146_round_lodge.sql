...
-- RLS Policies for channels table - check if they exist first
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'channels' 
    AND policyname = 'Users can select channels they are members of'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'channels' 
    AND policyname = 'Users can insert channels'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Users can select messages in channels they are members of'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'messages' 
    AND policyname = 'Users can insert messages into channels they are members of'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    ...
    AND policyname = 'Users can select channel membership information'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'channel_members' 
    AND policyname = 'Users can insert channel memberships if they created the channel'
  ) THEN
  ...
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'channel_members' 
    AND policyname = 'Users can update their own last_read_at timestamp'
  ) THEN
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
    WHERE tablename = 'chat_notifications' 
